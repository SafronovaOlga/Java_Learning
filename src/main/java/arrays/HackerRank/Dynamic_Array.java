...
public class Dynamic_Array {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("Hackerrank_tasks/src/Arrays/Dynamic_Array.txt"));
        ...
        IntStream.range(0, q).forEach((i) -> {
            try {
                queries.add((List) Stream.of(bufferedReader.readLine().
                        replaceAll("\\s+$", "")
                        .split(" "))
